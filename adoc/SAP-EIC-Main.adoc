...
== Shared Cluster for {eic}

// TODO: include more information about Shared Cluster for EIC
//       i.e., the reasons customers would go for this configuration

This section covers the steps for Shared Cluster setup in {eic}.
...
// TODO: include more information about Service Mesh for EIC
...
include::SAP-EIC-SharedCluster-main.adoc[tags=shared-cluster-namespaces, leveloffset=+1]

++++
<?pdfpagebreak?>
++++

include::SAP-EIC-SharedCluster-main.adoc[tags=shared-cluster-permissions, leveloffset=+1]

++++
<?pdfpagebreak?>
++++

include::SAP-EIC-SharedCluster-main.adoc[tags=shared-cluster-kubeconfig, leveloffset=+1]

++++
<?pdfpagebreak?>
++++

include::SAP-EIC-SharedCluster-main.adoc[tags=shared-cluster-registration, leveloffset=+1]
