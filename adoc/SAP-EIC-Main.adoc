...
This is an optional setup to onboard a shared Kubernetes cluster in Edge Lifecycle Management.
// TODO: include what reasons customers would go for this configuration
