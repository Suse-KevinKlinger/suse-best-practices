...
Installations of {elm} and {eic} with **Restricted Access** require specific namespaces. Follow the steps in https://me.sap.com/notes/3618713 to create and configure these namespaces.
...
_(//TODO) To be changed when ClusterRoleTemplate rules are provided (Simeon)._
...
Create a script file named `configuring_permissions.sh` with the following content:
