...
include::SAP-EIC-Istio-main.adoc[tags=istio-installation]
...
This section outlines the essential steps for configuring your Kubernetes cluster to properly host and run the {eic}. 
It includes creating necessary namespaces and permissions, generating a Kubeconfig file for the {eic} installation, and addressing important cluster infrastructure considerations.

include::SAP-EIC-Istio-main.adoc[tags=shared-cluster-permissions, leveloffset=+1]
